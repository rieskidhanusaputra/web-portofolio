...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between px-10 bg-blue-800">
      <div className="logo">
        <h1 className="text-3xl font-bold bg-white text-blue-800 md:bg-transparent md:text-white">
          RieskiDhanu.
        </h1>
      </div>
      <ul
        className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0 md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent transition-all md:transition-none z-40 ${
          active ? "top-0 opacity-100 text-black" : "-top-10 opacity-0"
        }`}
      >
        <li>
